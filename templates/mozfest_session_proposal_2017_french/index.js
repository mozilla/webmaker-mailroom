module.exports = {
  ...
  name: '2017 Mozilla Festival Session Proposal (French)',

  // Choose a good description; when is this email sent?
  description: 'When someone submits a session proposal in French on the Mozilla Festival website',

  // Choose a subject for your email
  subject: 'Votre proposition de session au MozFest',

  // Create a test case for every possible version of the email,
  // E.g. with a user name, without a username
  tests: [
    {
      description: 'Chris submits a proposal in French',
      data: {
        first_name: 'Chris',
        github_issue_url: "https://github.com/MozillaFoundation/mozfest-program-2017/issues/1",
        github_issue_title: "Comment faire un gâteau au chocolat"
      }
    }
  ]
};
